...
alnStats <-       read.delim(sub(".gff.gz", ".o2o_aln.tsv",        alnFilePath))
trainParams <- readTrainFile(sub(".gff.gz", ".train",              alnFilePath))

matrixFile <- sub(".gff.gz", ".o2o_aln.matrix.txt", alnFilePath)
