...
report$TargetSequences         <- alnStats$TargetSequences
report$TargetLength            <- alnStats$TargetLength
report$QuerySequences          <- alnStats$QuerySequences
report$QueryLength             <- alnStats$QueryLength
report$GBreaksPipelineVersion  <- "0.16.3.1"
```
