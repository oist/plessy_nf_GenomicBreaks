...
alnStats    <-    read.delim(sub(".blasttabplus.gz", ".o2o_aln.tsv",        alnFilePath))
trainParams <- readTrainFile(sub(".blasttabplus.gz", ".train",              alnFilePath))
matrixFile  <-               sub(".blasttabplus.gz", ".o2o_aln.matrix.txt", alnFilePath)
...
report$GBreaksPipelineVersion  <- "0.16.3.2"

report$P                       <- NAifNULL(if (is.null(countMatrix)) NULL else P_distance(countMatrix))
report$GBreaksPipelineVersion  <- "0.17.0.1"
...
report$GBreaksPipelineVersion  <- "0.19.0.1"
