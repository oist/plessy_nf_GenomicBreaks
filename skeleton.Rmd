...
trainParams <- readTrainFile(sub(".gff.gz", ".train", system2("realpath", alnFile, stdout = TRUE)))
...
report$JC69 <- JC69_distance(trainParams)
report$K80  <-  K80_distance(trainParams)
report$T92  <-  T92_distance(trainParams)
...
# Pipeline v.2.3
report$F81                     <- F81_distance(trainParams)
...
report$P                       <- P_distance(trainParams)
